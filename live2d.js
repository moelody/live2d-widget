! function(t) {
	...
	r.prototype.getModelMatrix = function() {
			...
			return null !== this.live2DModel && (t && i && e && r) && (e >= t[0] && e <= i[0] && r <= t[1] && r >= i[1])
			...
			Y._$V2 = -1, Y._$W0 = -1, Y._$jr = !1, Y._$ZS = !0, Y._$tr = -1e6, Y._$lr = 1e6, Y._$is = 32, Y._$e = !1, Y.prototype
				.getDrawDataIndex = function(t) {
					for (var i = this._$aS.length - 1; i >= 0; --i) 
                        ...
                        // console.log(this._$aS[i].getDrawDataID())
					return -1
	...
	o.prototype.createModel = function() {
		...
		for (var e = 0; e < this.models.length; e++) {
            if (this.models[e].hitTest($.default.HIT_AREA_HEAD, t, i)) 
            {
                $.default.DEBUG_LOG && console.log("Tap face. models[" + e + "]");
                this.models[e].setRandomExpression();
                this.models[e].startRandomMotion($.default.MOTION_GROUP_TAP_HEAD, $.default.PRIORITY_NORMAL);
            } 
            else if (this.models[e].hitTest($.default.HIT_AREA_BREAST, t, i)) 
            {
                $.default.DEBUG_LOG && console.log("Tap breast. models[" + e + "]");
                this.models[e].startRandomMotion($.default.MOTION_GROUP_TAP_BREAST, $.default.PRIORITY_NORMAL);
            }
            else if (this.models[e].hitTest($.default.HIT_AREA_BODY, t, i)) 
            {
            ...
            else if (this.models[e].hitTest($.default.HIT_AREA_HAND, t, i)) 
            {
                $.default.DEBUG_LOG && console.log("Tap body. models[" + e + "]");
                this.models[e].startRandomMotion($.default.MOTION_GROUP_TAP_HAND, $.default.PRIORITY_NORMAL);
            }
            else if (this.models[e].hitTest($.default.HIT_AREA_LEG, t, i))
            {
                $.default.DEBUG_LOG && console.log("Tap leg. models[" + e + "]");
                this.models[e].startRandomMotion($.default.MOTION_GROUP_TAP_LEG, $.default.PRIORITY_NORMAL);
            }
            else if (this.models[e].hitTestCustom("head", t, i))
            {
                $.default.DEBUG_LOG && console.log("Tap custom face. models[" + e + "]");
                this.models[e].setRandomExpression();
                this.models[e].startRandomMotion($.default.MOTION_GROUP_FLICK_HEAD, $.default.PRIORITY_NORMAL);
            }
            else if (this.models[e].hitTestCustom("body", t, i))
            {
                $.default.DEBUG_LOG && console.log("Tap custom body. models[" + e + "]");
                this.models[e].startRandomMotion($.default.MOTION_GROUP_TAP_BODY, $.default.PRIORITY_NORMAL);
            } else {
                // $.default.DEBUG_LOG && console.log("Tap. models[" + e + "]");
                // this.models[e].startRandomMotion($.default.MOTION_GROUP_TAP, $.default.PRIORITY_NORMAL);
            }
        }
		return !0
	}
	...
	o.prototype = new n.L2DBaseModel, o.prototype.load = function(t, i, e) {
				...
				for (var i = 0; i < r.modelSetting.getTextureNum(); i++) {
					...
					r.loadTexture(i, o, function() {
						if (r.isTexLoaded) {
							...
							r.live2DModel.saveParam(), r.preloadMotionGroup(h.default.MOTION_GROUP_START), r.preloadMotionGroup(h.default.MOTION_GROUP_IDLE), r.preloadMotionGroup(h.default
		...
		for (var i = this, e = 0; e < this.modelSetting.getMotionNum(t); e++) {
            ...
            if (t == h.default.MOTION_GROUP_START) this.startRandomMotion(h.default.MOTION_GROUP_START, h.default.PRIORITY_NORMAL);
		}
        ...
        if (!Object.keys(this.expressions).length) return;
	...
	},o.prototype.startSound = function(t, i, e, r) {
        var nums, n = this.modelSetting.getMotionSound(t, i),
		...
		if (r.setFadeIn(this.modelSetting.getMotionFadeIn(t, i)), r.setFadeOut(this.modelSetting.getMotionFadeOut(t, i)),
			h.default.DEBUG_LOG && console.log("Start motion : " + o), null == this.modelSetting.getMotionSound(t, i)) this.mainMotionManager.startMotionPrio(r, e);
		else this.startSound(t, i, e, r);
	...
	}, r.prototype.getModelFile = function(j) {
		j = this.json[this.MODEL];
		return 'string' == typeof(j) ? j : j[Math.floor(Math.random() * Object.keys(j).length) + 1];
